 ...
 * manifest, load its JS/CSS from the clibs origin (cross-origin —
 * clibs must send back CORS headers for this site's origin) and mark
...
async function preloadFederatedBlocks(main) {
  ...
  await Promise.all(blocks.map(async (block) => {
    ...
    try {
      ...
      block.dataset.resolvedFrom = 'clibs';
    } catch (error) {
      // eslint-disable-next-line no-console
